...
2. Prepare a bounded evidence packet:
   ...
   ```bash
   node skills/C_external-skill-adapter/scripts/prepare-adaptation.mjs \
...
5. Write a clean project-owned skill. Do not keep a conflicting upstream instruction beside a corrective wrapper. Keep the exact upstream snapshot outside `skills/` and register its origin and hashes.

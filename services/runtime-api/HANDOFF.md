...
- Bounded player-facing delivery is no longer only a generic action catalog: `game.manifest.json` now includes `content.antarctica` for intro info `i0`, boards `1..6`, `7..12`, `13..18`, `19..24`, `25..30`, `31..36`, `37..42` and `43..48`, team-selection step `15`, plus infos `i7`, `i8`, `i9`, `i10`, `i11`, `i12`, `i13`, `i14`, `i14_2` and `i15`, the content endpoint projects it directly, and `player-web` resolves those scenes from the current session snapshot with a safe fallback for unmigrated steps.
...
- team-selection mechanics for step `15` and the immediate `i10` follow-up are implemented, and the post-confirm mainline path now reaches terminal `i21`; the current player-facing delivery slice now also reaches board `31..36`, `i13`, board `37..42`, `i14`, `i14_2`, board `43..48` and `i15`, so the next engineering gap is extending beyond this bounded slice rather than another unreached opening board;
...
3. Первый bounded Antarctica player-facing delivery slice уже реализован: `player-web` рендерит `i0`, board `1..6`, `i7`, board `7..12`, `i8`, team-selection step `15`, `i10`, board `19..24`, `i11`, board `25..30`, `i12`, board `31..36`, `i13`, board `37..42`, `i14`, `i14_2`, board `43..48` и `i15` из `content.antarctica` и существующего session snapshot.

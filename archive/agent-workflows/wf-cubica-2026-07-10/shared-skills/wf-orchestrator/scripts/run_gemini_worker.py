#!/usr/bin/env python3
"""Compile a workflow prompt packet and run it through the canonical Gemini CLI runner."""
...
WRAPPER = SCRIPT_DIR.parents[1] / "cli-subagents" / "scripts" / "run_gemini_subagent.py"

...
| LEGACY-0018 | editor-engine | packages/editor-engine/src/index.ts | full project review 2026-06-27 | Разбить переросший модуль editor-engine и компонент EditorWorkspace в `TSK-20260630-editor-engine-modularization` | Frontend Team | active | ~5400-строчный модуль и ~2500-строчный компонент; поведение не меняется |
| LEGACY-0019 | editor-engine | packages/editor-engine/src/index.ts | full project review 2026-06-27 | Сделать инференс ролей schema-driven в `TSK-20260630-editor-engine-modularization` | Frontend Team | active | Классификация по английским подстрокам деградирует для не-английских манифестов |
| LEGACY-0020 | runtime-api | services/runtime-api/src/modules/runtime/deterministicHandlers.ts | full project review 2026-06-27 | Согласовать legacy-guard-ы с дженерик-guard-ами ADR-041 в `TSK-20260630-runtime-guard-reconciliation` | Platform Team | active | Две системы guard-ов; платформенная схема несёт game-specific формы |
| LEGACY-0021 | SDK/react-sdk | SDK/react-sdk | full project review 2026-06-27 | Удалить или классифицировать мёртвый workspace и session-половину SDK/core в `TSK-20260630-codebase-cleanup-and-workspace-status` | Platform Team | active | Ноль production-импортов; дублирует packages/contracts/session |
| LEGACY-0022 | player-web | apps/player-web/src/lib/metric-projection.ts | full project review 2026-06-27 | Унифицировать вычисление JsonLogic или задокументировать подмножество с CI-проверкой в `TSK-20260630-codebase-cleanup-and-workspace-status` | Frontend Team | active | Дублирует runtime json-logic-js; риск расхождения каналов |

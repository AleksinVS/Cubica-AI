...
| LEGACY-0031 | SDK strategy | docs/architecture/adrs/014-viewers-library-architecture.md | architecture review 2026-07-06 | Принять решение о судьбе SDK-слоя: пометить ADR-014 и слоистую SDK-стратегию как Superseded либо осознанно возродить | Platform Team | active | Роль SDK-слоя фактически занята plugin-архитектурой ADR-037/039/055; связано с LEGACY-0005/0011/0021 |
...
| LEGACY-0036 | editor-web hosting | docs/architecture/editor-preview-first-ux.md | architecture review 2026-07-06 | Спроектировать хостируемый многопользовательский редактор (авторизация авторов, изоляция проектов, коллаборация) | Frontend Team | active | Текущий editor-web — локальный инструмент с Git worktree-сессиями |

...
- `product-context-system.md` — отдельный черновой трек продуктовых знаний и ситуативной осведомлённости пользовательских агентов: сырые диалоги и предложения в PostgreSQL, подтверждённая Markdown-вики с управляемой Git-историей, универсальные области владения, совместно созданные знания, строго локальные патчи, обслуживание без языковой модели и навигация через `index.md` по Draft ADR-089.

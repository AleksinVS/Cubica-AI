...
- `product-context-system.md` — отдельный черновой трек продуктовых знаний и ситуативной осведомлённости пользовательских агентов: сырые диалоги в PostgreSQL, подтверждённая OKF-совместимая Markdown-вики, одна пользовательская поверхность из изолированных пакетов, навигация через `index.md`, приватность и встраивание в платформу по Draft ADR-088.

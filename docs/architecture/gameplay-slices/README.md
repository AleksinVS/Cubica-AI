...
- `GSR-042` - Estate Race: две скрытые колоды, удерживаемая actor-private карта выхода, полный game-owned цикл тюрьмы и server-owned browser flow; S3 завершён, а P-01 остаётся воротом окончательного публичного содержания.

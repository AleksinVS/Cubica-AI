...
- `GSR-042` - Estate Race: две скрытые колоды, удерживаемая карта выхода и полный game-owned цикл тюрьмы; S3 заблокирован решением PM по actor-private листу внутри публичной `state.players` record-map.

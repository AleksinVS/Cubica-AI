...
- `GSR-052` - Estate Race: принятая ограниченная локальная проверка финала человека и автосоперника с заранее подготовленным позднеигровым состоянием, победителем от сервера, стабильным повтором и проекцией/квитанцией в пределах участника; не является полной партией или проверкой стратегии.
- `GSR-053` - Estate Race: готовность к локальному наблюдению экономики и длительности по существующему публичному журналу и доверенному манифесту; не является реальными alpha-наблюдениями, финальным балансом или production readiness.

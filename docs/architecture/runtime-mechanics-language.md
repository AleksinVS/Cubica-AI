...
на него стоимость тела, а runtime повторно сортирует идентификаторы
канонически независимо от порядка производной. Тело содержит не более
шестнадцати существующих шагов; вложенный `each`, рекурсия, `goto` и

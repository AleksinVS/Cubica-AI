...
Уточнение от 2026-09-19 (MVP ADR-057): панель элемента показывает три отдельных
блока — разовый произвольный промт, сохраняемое авторское описание и актуальную
YAML-проекцию. Разовый промт не становится частью `_prompt`. Авторское описание

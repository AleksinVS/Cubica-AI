...
8. Разрешенные переходы между состояниями остаются частью логики действий, guards и effects. Сама state model перечисляет допустимые значения и хранит текущее состояние, но не становится workflow engine.

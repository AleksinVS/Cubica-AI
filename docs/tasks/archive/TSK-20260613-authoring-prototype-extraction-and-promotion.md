...
- `docs/tasks/archive/TSK-20260613-authoring-prototype-extraction-and-promotion.md` - этот исполнительный план.
...
- Изменено:
  - `docs/tasks/archive/TSK-20260613-authoring-prototype-extraction-and-promotion.md`

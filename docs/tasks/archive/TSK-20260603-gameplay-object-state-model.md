...
- `Antarctica` migration replaces `flags.cards`; no permanent legacy fallback is accepted. Execution is tracked separately in `docs/tasks/archive/TSK-20260603-antarctica-object-state-migration.md`.
...
Moved out of this package: `Antarctica` migration from `state.public.flags.cards` to `state.public.objects.cards` is now owned by `docs/tasks/archive/TSK-20260603-antarctica-object-state-migration.md`.
...
- `docs/tasks/archive/TSK-20260603-antarctica-object-state-migration.md` - separate execution package for `Antarctica` migration
...
- Created `docs/tasks/archive/TSK-20260603-antarctica-object-state-migration.md`.

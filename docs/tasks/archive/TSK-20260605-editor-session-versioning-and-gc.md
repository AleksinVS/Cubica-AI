...
- `docs/tasks/archive/TSK-20260605-editor-session-versioning-and-gc.md` - execution plan and handoff.
...
- Changed:
  ...
  - `docs/tasks/archive/TSK-20260605-editor-session-versioning-and-gc.md`

...
- `git diff --check -- docs/architecture/adrs/045-cubica-owned-generative-ui-and-mvp-copilotkit.md docs/architecture/generative-ui-surface-protocol.md docs/tasks/active/TSK-20260610-cubica-generative-ui-surface-protocol.md`

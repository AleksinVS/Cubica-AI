...
- DR-26 требует решения PM: официальная документация 2026-09-18 сообщает,
  ...
  DR-25 не активируется до решения о явной модели и локальной проверки её
  адаптера; настройки и разрешение окна пока не изменены.

...
- Changed: `docs/architecture/adrs/053-game-defined-ui-panels.md`, `docs/architecture/PROJECT_ARCHITECTURE.md`, `docs/tasks/active/TSK-20260615-game-defined-ui-panels-journal.md`, `NEXT_STEPS.md`.
...
- Remaining: migrate nearby UI-only game actions (`showHint`, `showTopBar`, `showScreenWithLeftSideBar`) in `docs/tasks/active/TSK-20260615-antarctica-ui-only-actions-cleanup.md`.

...
- **Связанные документы**: `docs/architecture/generative-ui-surface-protocol.md`, `docs/architecture/adrs/046-ai-driven-game-runtime-mode.md`, `docs/tasks/active/TSK-20260610-cubica-generative-ui-surface-protocol.md`, `docs/tasks/active/TSK-20260611-ai-driven-game-runtime-mode.md`
...
- `git diff --check -- docs/tasks/active/TSK-20260611-ai-driven-surface-architecture-migration.md docs/tasks/active/.desc.json NEXT_STEPS.md PROJECT_STRUCTURE.yaml`
...
- `docs/tasks/active/TSK-20260610-cubica-generative-ui-surface-protocol.md` - implementation task for Surface Protocol.
- `docs/tasks/active/TSK-20260611-ai-driven-game-runtime-mode.md` - implementation task for AI-driven runtime mode.
...
- Changed:
  - `docs/tasks/active/TSK-20260611-ai-driven-surface-architecture-migration.md`

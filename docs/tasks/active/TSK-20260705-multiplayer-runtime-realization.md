...
2026-08-13; S9 интегрирован в `main` 2026-08-23. Исходный пакет S10 принят PM
2026-08-24, но параллельный коммит `99019ca` реализовал более простой
SSE-вариант с долговечным удостоверением места. По прямому указанию PM этот
вариант не отменяется; до интеграции требуется согласовать транспорт и
одноразовость приглашения. Исходное решение и аудит вариантов находятся в

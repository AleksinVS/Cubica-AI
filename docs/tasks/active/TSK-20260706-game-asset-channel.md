...
Status note: архитектура ADR-063 принята 2026-07-06, но отдельного разрешения на весь план нет. Нужные фазы активируются игровым срезом или приоритетом PM.

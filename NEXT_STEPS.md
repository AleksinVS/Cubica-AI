...
- [TSK-20260603-antarctica-object-state-migration](docs/tasks/active/TSK-20260603-antarctica-object-state-migration.md) — отдельный пакет миграции `Antarctica` с `flags.cards` на `objects.cards` без постоянного fallback; следующий шаг — заполнить migration map и только затем менять authoring manifest.

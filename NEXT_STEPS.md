...
- [TSK-20260613-authoring-prototype-extraction-and-promotion](docs/tasks/active/TSK-20260613-authoring-prototype-extraction-and-promotion.md) — implemented-third-slice: `editor-engine` строит prototype proposal, `editor-web` добавил read-only `/api/editor/prototype-extraction` с compiler/runtime-diff/source-map gates, assistant tools `editor.proposePrototypeExtraction`/`editor.preparePrototypeChangeSet`, ручной `Use as planned ChangeSet` и process doc для promotion governance; следующий шаг — dedicated review UI с группами источников/параметрами и e2e preview-selection proof.

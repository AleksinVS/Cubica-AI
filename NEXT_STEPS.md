...
- [TSK-20260603-gameplay-object-state-model](docs/tasks/active/TSK-20260603-gameplay-object-state-model.md) — реализовать ADR-041: authoring-first фасетное состояние игровых объектов, runtime object effects/guards, Presenter-проекцию, fixture proof и полную миграцию `Antarctica` без постоянного `flags.cards` fallback.

 ...
 *   node scripts/manifest-tools/generate-contracts-types.cjs --job=editor-preview-scene-response
 *
...
export interface EditorPreviewSceneResponse {
  source: "cubica-player-web";
  type: "previewSceneResult";
  protocolVersion: 1;
  requestId: string;
  sessionId: string;
  ok: boolean;

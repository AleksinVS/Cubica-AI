 ...
 *   node scripts/manifest-tools/generate-contracts-types.cjs --job=editor-prototype-preview-request
 *
...
export interface EditorPrototypePreviewRequest {
  gameId: string;
  filePath: string;
  sourcePointer: string;
  prototypePointer: string;

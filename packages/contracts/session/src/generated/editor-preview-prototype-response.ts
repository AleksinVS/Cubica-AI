 ...
 *   node scripts/manifest-tools/generate-contracts-types.cjs --job=editor-preview-prototype-response
 *
...
export interface EditorPreviewPrototypeResponse {
  source: "cubica-player-web";
  type: "previewPrototypeResult";
  protocolVersion: 1;
  requestId: string;
  sessionId: string;
  ok: boolean;

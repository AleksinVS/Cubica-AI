 ...
 *   node scripts/manifest-tools/generate-contracts-types.cjs --job=editor-preview-prototype-request
 *
 ...
 *
 * This interface was referenced by `EditorPreviewPrototypeRequest`'s JSON-Schema
...
export interface EditorPreviewPrototypeRequest {

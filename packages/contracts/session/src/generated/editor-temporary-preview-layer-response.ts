 ...
 *   node scripts/manifest-tools/generate-contracts-types.cjs --job=editor-temporary-preview-layer-response
 *
...
export interface EditorTemporaryPreviewLayerResponse {
  source: "cubica-player-web";
  type: "temporaryPreviewLayerResult";
  protocolVersion: 1;
  requestId: string;
  sessionId: string;
  sequence: number;

...
Основные положения:
  ...
  - **Структура манифеста может различаться у разных игр**.
    ...
    - Бэкенд (`services/runtime-api`) использует стандартный компилятор `ajv` для декларативной проверки входящих манифестов по этой схеме. Переход к строгому Ajv-режиму и снятие ручных исключений отслеживает `docs/tasks/active/TSK-20260518-json-schema-strict-validation.md`.
